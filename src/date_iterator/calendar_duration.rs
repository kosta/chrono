...
impl CalendarDuration {
    /// returns a CalendarDuration representing the given number of years
    ...
    /// returns a CalendarDuration representing the given number of months
    ...
    /// returns a CalendarDuration representing the given number of weeks
    ...
    /// returns a CalendarDuration representing the given number of days
    ...
    /// returns a CalendarDuration representing the given number of hours
    ...
    /// returns a CalendarDuration representing the given number of minutes
    ...
    /// returns a CalendarDuration representing the given number of seconds
    ...
    /// returns a CalendarDuration representing the given number of milliseconds
    ...
    /// returns a CalendarDuration representing the given number of microseconds
    ...
    /// returns a CalendarDuration representing the given number of nanoseconds
    ...
    /// returns a CalendarDuration representing a "zero" duration (no elapsed time)
    ...
    /// returns the part of CalendarDuration that can accurately be expressed in a fixed time, i.e. without months and years
    ...
    //TODO: Implement checked_mul once there is a new super::Duration type
...
/// Return a `DateTime` with the given amount of years added to it (or none)
pub fn add_years<Tz: TimeZone>(dt: &DateTime<Tz>, years: i32) -> Option<DateTime<Tz>> {
    dt.with_year(try_opt!(dt.year().checked_add(years)))
}

/// Return a `NaiveDate` with the given amount of months added to it (or none)
...
/// Return a `NaiveDateTime` with the given amount of months added to it (or none)
...
/// Return a `DatTime` with the given amount of months added to it (or none)
